...
export default function App() {
  const [form, setForm] = useState<DDTInputForm>({
    patientName: '',
    bdName: '',
    shootDate: formatDateToDDMMYYYY(new Date().toISOString().split('T')[0]),
    shootLocation: 'Hospital',
    source: 'Outbound Medical',
    jiraLink: 'https://impactguruinc.atlassian.net/browse/AM-13070',
    driveLink: 'https://drive.google.com/drive/folders/1CXYwsH4VSOmZOR947S5H3hDhD_00TE0v?usp=drive_link',
    callRecording: null,
    estimateLetter: null,
    oldPics: [],
    hospitalPics: [],
  ...
  const handleSelectCaseFromHistory = (summary: GeneratedCaseSummary) => {
    ...
    setForm({
      ...
      shootDate: formatDateToDDMMYYYY(summary.shootDate || new Date().toISOString().split('T')[0]),
      shootLocation: 'Hospital',
      source: 'Outbound',
      jiraLink: summary.jiraLink || summary.parsedDetails?.jiraLink || 'https://impactguruinc.atlassian.net/browse/AM-13070',
      driveLink: summary.driveLink || summary.parsedDetails?.driveLink || 'https://drive.google.com/drive/folders/1CXYwsH4VSOmZOR947S5H3hDhD_00TE0v?usp=drive_link',
      callRecording: null,
      estimateLetter: null,
      oldPics: [],
      hospitalPics: [],
