...
export const StructuredDetailsCard: React.FC<StructuredDetailsCardProps> = ({
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Card 5: Attached DDT Resources & Links (Jira Card & Google Drive) */}
      <div className="bg-gradient-to-r from-blue-50/80 via-indigo-50/80 to-purple-50/80 border border-blue-200/80 rounded-xl p-5 shadow-xs space-y-3">
        <div className="flex items-center justify-between border-b border-blue-100 pb-3">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h3 className="text-sm font-bold text-slate-900">Attached DDT Tracking Links</h3>
              <p className="text-[11px] text-slate-500">Quick access to Jira ticket and Google Drive folder for this case</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
          {/* Jira Link Card */}
          <div className="bg-white p-3.5 rounded-lg border border-slate-200 flex flex-col justify-between shadow-2xs hover:border-blue-300 transition-all">
            <div className="flex items-start justify-between">
              <div className="flex items-center space-x-2">
                ...
                <div className="overflow-hidden">
                  <span className="text-xs font-bold text-slate-900 block">Jira Card Link</span>
                  <span className="text-[10px] text-slate-500 block truncate max-w-[210px] font-mono">
                    {details.jiraLink || 'https://impactguruinc.atlassian.net/browse/AM-13070'}
                  </span>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-2 mt-3 pt-2 border-t border-slate-100">
              <a
                href={details.jiraLink || 'https://impactguruinc.atlassian.net/browse/AM-13070'}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-md transition-colors shadow-2xs cursor-pointer flex-1"
              >
                <ExternalLink className="w-3.5 h-3.5" /> Open Jira Ticket ↗
              </a>
            </div>
          </div>

          {/* Drive Link Card */}
          <div className="bg-white p-3.5 rounded-lg border border-slate-200 flex flex-col justify-between shadow-2xs hover:border-emerald-300 transition-all">
            <div className="flex items-start justify-between">
              <div className="flex items-center space-x-2">
                ...
                <div className="overflow-hidden">
                  <span className="text-xs font-bold text-slate-900 block">Google Drive Link (for DDT)</span>
                  <span className="text-[10px] text-slate-500 block truncate max-w-[210px] font-mono">
                    {details.driveLink || 'https://drive.google.com/drive/folders/1CXYwsH4VSOmZOR947S5H3hDhD_00TE0v?usp=drive_link'}
                  </span>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-2 mt-3 pt-2 border-t border-slate-100">
              <a
                href={details.driveLink || 'https://drive.google.com/drive/folders/1CXYwsH4VSOmZOR947S5H3hDhD_00TE0v?usp=drive_link'}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white bg-emerald-600 hover:bg-emerald-700 rounded-md transition-colors shadow-2xs cursor-pointer flex-1"
              >
                <FolderSymlink className="w-3.5 h-3.5" /> Open Drive Folder ↗
              </a>
            </div>
          </div>
        </div>
