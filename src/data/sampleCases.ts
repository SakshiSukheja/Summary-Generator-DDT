...
const sampleShootDate = formatDateToDDMMYYYY(new Date().toISOString().split('T')[0]);

export const SAMPLE_INPUT_BABY_PRIYANKA: DDTInputForm = {
  patientName: 'Baby of Priyanka',
  bdName: 'Rohan Sharma',
  shootDate: sampleShootDate,
...
export const SAMPLE_GENERATED_SUMMARY_BABY_PRIYANKA: GeneratedCaseSummary = {
  ...
  jiraLink: 'https://impactguruinc.atlassian.net/browse/AM-13070',
  driveLink: 'https://drive.google.com/drive/folders/1CXYwsH4VSOmZOR947S5H3hDhD_00TE0v?usp=drive_link',
  jiraCardText: `Shoot Date:- ${sampleShootDate} Confirmed with the campaigner
